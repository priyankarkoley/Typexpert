    ...
    <>
      ...
      {/* only when not in phone */}
        <div className="bg-green-200 flex justify-center md:items-center md:min-h-screen">
          ...
          <div className="bg-green-100 md:w-2/3 rounded-lg lg:p-4"> <Main totalTime={totalTime} settotalTime={settotalTime} time={time} setTime={setTime} text={text} setText={setText}/> </div>
          <div className="bg-green-100 md:w-1/3 rounded-lg lg:p-4"> <Dashboard totalTime={totalTime} settotalTime={settotalTime} text={text} setText={setText}/> </div>        
          </div>
      </div>  
    </>
  );

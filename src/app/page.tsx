  ...
  return (
      <div className="h-screen w-full relative flex-col justify-center">
        <div className="absolute -z-50 bg-fixed bg-gray-900 w-full h-full">
          <div className="opacity-40 blur-3xl rounded-full sm:w-44 sm:h-64 w-44 h-64 absolute top-1/2 -mt-10 left-2/3 -ml-32 animate-circlesm z-10 bg-violet-800"></div>
          <div className="opacity-40 blur-3xl rounded-full sm:w-64 sm:h-96 w-64 h-96 absolute top-1/2 -mt-72 left-1/2 -ml-32 animate-circlemd -z-50 bg-yellow-600"></div>
          <div className="opacity-40 blur-3xl rounded-full sm:w-52 sm:h-80 w-52 h-80 absolute top-1/2 -mt-80 left-1/3 -ml-32 animate-circlexl z-20 bg-red-500"></div>
          <div className="opacity-40 blur-3xl rounded-full sm:w-52 sm:h-80 w-52 h-80 absolute top-1/2 -mt-52 left-1/3 -ml-32 animate-circlesm -z-20 bg-green-600"></div>
          <div className="opacity-40 blur-3xl rounded-full sm:w-20 sm:h-40 w-20 h-40 absolute top-1/2 -mt-96 left-2/3 -ml-12 animate-circlexl -z-20 bg-cyan-600"></div>
        </div>
        <Navbar />
